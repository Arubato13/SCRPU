...
MySQL - 5.5.5-10.1.13-MariaDB : Database - pu_ingenieria
*********************************************************************
*/
...
insert  into `pu04regtra`(`PU04IDTRA`,`PU04FETRA`,`PU04NORTE`,`PU04ESTE`,`PU04ALTITUD`) values (1,'2018-05-27 20:57:34',123,123,432),(4,'2018-06-01 09:22:25',1234,4321,44423),(60871,'2018-06-01 10:12:24',109207,330645,36),(123445,'2018-06-14 08:07:13',4452,3342,1121);
...
insert  into `pu04tramite1`(`PU04IDTRA`,`PU0INDICETRA`,`PU04FEINICIO`,`PUIDESTADO`) values (1,152,'2018-05-27 20:57:20',7),(2,153,'2018-05-31 22:01:39',1),(3,154,'2018-05-31 22:04:27',1),(4,155,'2018-06-01 09:22:02',7),(60871,156,'2018-06-01 10:00:33',7),(123445,157,'2018-06-14 08:06:41',7);
...
insert  into `pu04tramite2`(`PU04IDTRA`,`PU04FEPLATAFOR`,`PU04IDDISTRITO`) values (1,'2018-05-27 00:00:00',1),(2,'2018-05-31 00:00:00',1),(3,'2018-05-31 00:00:00',1),(4,'2018-06-01 00:00:00',1),(60871,'2018-05-21 00:00:00',5),(123445,'2018-06-14 00:00:00',1);
...
insert  into `pu06tracomercial_industrial`(`PU04IDTRA`,`PU06IDACTDES`) values (1,28),(4,16),(4,17),(123445,16),(123445,17);
...
insert  into `pu09tradeg`(`PU04IDTRA`,`PU09IDDEG`) values (1,1),(1,2),(1,3),(1,4),(1,6),(4,1),(4,6),(60871,1),(123445,2),(123445,4),(123445,6);
...
insert  into `pu11uniabio`(`PU04IDTRA`,`PU10IDASBIO`) values (1,1),(4,1),(4,3),(60871,3),(123445,2),(123445,6);
...
insert  into `pu12tratipdesec`(`PU04IDTRA`,`PU12IDTDESEC`) values (1,1),(4,1),(60871,1),(123445,1),(123445,2);
...
insert  into `pu14trarep`(`PU04IDTRA`,`PU13IDAAP`) values (1,2),(1,8),(2,1),(2,2),(3,2),(4,1),(60871,12),(123445,2),(123445,7);
...
insert  into `pu22traserv`(`PU04IDTRA`,`PU22IDTREDV`) values (1,1),(4,1),(60871,3),(123445,1);
...
insert  into `pu25patent`(`PU04IDTRA`,`PU24IDINFR`) values (1,3),(4,3),(60871,3),(123445,3);
...
insert  into `pu26planregtramite`(`PU04IDTRA`,`PU26IDPLAN`) values (1,1),(2,1),(3,1),(4,1),(60871,3),(123445,1);
...
insert  into `pu38traservidumbres`(`PU04IDTRA`,`PU38IDSERVIDUMBRE`) values (1,1),(2,1),(3,1),(4,1),(60871,1),(123445,1);
...
insert  into `pu39reginfosolicitante`(`PU39CEDSOLICI`,`PU04IDDISTRITO`,`PU39BARRIO`,`PU39DIRECCION`) values (109340746,5,'Cartagena','Del hotel cartagena 600 mestros norte'),(504650654,1,'La virginia','125 metros sur del antiguo radio la pampa'),(504940434,1,'La virginia','Por ahÃ­'),(506540546,1,'La virginia','Por ahi');
...
insert  into `pu39regsolicitante`(`PU04IDTRA`,`PU39CEDSOLICI`,`PU39NOMSOLICI`,`PU39APE1SOLICI`,`PU39APE2SOLICI`) values (60871,109340746,'Fabricio','Jimenez','Alfaro'),(123445,504650654,'Alberto','JimÃ¨nez','Obando'),(1,504940434,'Carlos','Espinoza','Chavarria'),(4,506540546,'Maria','Jimenez','Ortiz');
...
insert  into `pu40reginfopropietario`(`PU40CEDPROPIE`,`PU40NFINCA`,`PU40NCATASTRO`) values (109340746,'500098716','1189578-2007'),(506960454,'564345-000','8436234-2018'),(604340543,'234543-000','5321223-2018'),(605450434,'234223-000','1232234-2018');
...
insert  into `pu40regpropietario`(`PU04IDTRA`,`PU40CEDPROPIE`,`PU40NOMPROPIE`,`PU40APE1PROPIE`,`PU40APE2PROPIE`) values (60871,109340746,'Fabricio','Jimenez','Alfaro'),(4,506960454,'Jose','Espinoza','Ortiz'),(123445,604340543,'MarÃ­a','Espinoza','Espinoza'),(1,605450434,'MarÃ­a','Cruz','Zamora');
...
insert  into `pu46traleyaspectobio`(`pu04idtra`,`pu45idley`) values (1,3);
...
insert  into `pu46traleydesarrosect`(`pu04idtra`,`pu45idley`) values (1,12);
...
insert  into `pu46traleyespaciosgeo`(`pu04idtra`,`pu45idley`) values (1,12);
